                ...
                <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
                    ...
                    <div className="w-full md:w-1/2 md:px-3">
                        ...
                        <h1 className="text-4xl font-extrabold tracking-wide text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                            <span className="block xl:inline font-custom font-normal tracking-wider text-[#0a6999]">Gonzo</span>
                            {/* <span className="block xl:inline text-gray-600">'s</span> */}

                            <span className="block text-[#919ac9] tracking-wide xl:inline">Treasure </span>
                        </h1>
                        <p className="mx-auto text-base font-sans font-extrabold text-black sm:max-w-md lg:text-xl md:max-w-3xl">Hodl it to Get Rich.Introducing Treasure of Gonzo, the most meme-worthy memecoin in the galaxy. The dogs have had their moment—now it’s time for Gonzo to claim the throne!</p>
                        <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                            <a href="#_" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white tracking-wide bg-[#0a6999] rounded-md sm:mb-0 hover:bg-[#818dc7] sm:w-auto">
                            How To Buy
                            ...
                            <a href="/trade" className="flex items-center px-6 py-3 text-white bg-[#f8b447] rounded-md hover:bg-[#a10d25] tracking-wide hover:text-white">
                            Buy Now
                            </a>
                        </div>
                        </div>
                    ...
                    <div className="w-full md:w-1/2 relative ">
                        <div className="w-full h-auto overflow-hidden relative bg-transparent transition-[all_400ms_cubic-bezier(0.03,0.98,0.52,0.99)_0s] will-change-transform "
                        ...
                        <div className="w-full h-auto overflow-hidden  relative bg-transparent transition-[all_400ms_cubic-bezier(0.03,0.98,0.52,0.99)_0s] will-change-transform "
                            ...
                            <img src="https://getdrawings.com/cliparts/the-muppets-clipart-26.gif" className=" relative flex h-full w-full select-none items-center z-30 drop-shadow-sm "/>
                        </div>
                    </div>
                    </div>
                </div>
